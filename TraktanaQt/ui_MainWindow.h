...
**
** Created: Wed Nov 3 12:25:48 2010
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("icons/refresh_32.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionRestart->setIcon(icon2);
        actionConnect = new QAction(MainWindow);
        actionConnect->setObjectName(QString::fromUtf8("actionConnect"));
        actionConnect->setCheckable(true);
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("icons/connect.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        actionConnect_Debug->setCheckable(true);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("icons/connectbug.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionConnect_Debug->setIcon(icon4);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("icons/cog.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSerialDeviceConfig->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("icons/cogbug.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSerialDebugConfig->setIcon(icon6);
        actionAbout = new QAction(MainWindow);
        actionAbout->setObjectName(QString::fromUtf8("actionAbout"));
        actionDisconnect = new QAction(MainWindow);
        actionDisconnect->setObjectName(QString::fromUtf8("actionDisconnect"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("icons/disconnect.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDisconnect->setIcon(icon7);
        actionDisconnectDebug = new QAction(MainWindow);
        actionDisconnectDebug->setObjectName(QString::fromUtf8("actionDisconnectDebug"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8("icons/disconnectbug.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionDisconnectDebug->setIcon(icon8);
        ...
        textEditDebug = new QTextEdit(subwindowDebug);
        textEditDebug->setObjectName(QString::fromUtf8("textEditDebug"));
        textEditDebug->setGeometry(QRect(10, 90, 241, 171));
        widget = new QWidget(subwindowDebug);
        widget->setObjectName(QString::fromUtf8("widget"));
        widget->setGeometry(QRect(10, 10, 225, 68));
        formLayout = new QFormLayout(widget);
        formLayout->setObjectName(QString::fromUtf8("formLayout"));
        formLayout->setContentsMargins(0, 0, 0, 0);
        labelCmd = new QLabel(widget);
        labelCmd->setObjectName(QString::fromUtf8("labelCmd"));

        formLayout->setWidget(1, QFormLayout::LabelRole, labelCmd);

        lineEditDebugCmd = new QLineEdit(widget);
        lineEditDebugCmd->setObjectName(QString::fromUtf8("lineEditDebugCmd"));

        formLayout->setWidget(1, QFormLayout::FieldRole, lineEditDebugCmd);

        pushButtonSend = new QPushButton(widget);
        pushButtonSend->setObjectName(QString::fromUtf8("pushButtonSend"));

        formLayout->setWidget(2, QFormLayout::LabelRole, pushButtonSend);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        labelCmd->setText(QApplication::translate("MainWindow", "Command:", 0, QApplication::UnicodeUTF8));
