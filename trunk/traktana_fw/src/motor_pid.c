...
*/
        ...
        //ADPCFG Register
        //Set up AN12 as analog input and configure rest as digital
        TRISB |= 0x1000;
		ADPCFG = 0xFFFF;
        ADPCFGbits.PCFG12 = 0;
		
		//Vref set to AVss and AVdd
		ADCON2bits.VCFG = 0;
        ...
        //ADCON2 Register
        //Set up A/D for interrupting after 1 sample get filled in the buffer
        //All other bits to their default state
        ADCON2bits.SMPI = 0;
        ...
        //A/D Interrupt Priority set to highest
		IPC2bits.ADIP = 7;
